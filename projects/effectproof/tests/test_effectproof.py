...
from effectproof import EffectContract, Rule, Verdict, diff, proof_id, verify
from effectproof.cli import main
...
def test_allowed_effect_and_required_postcondition_verify():
    before, after = calendar_states()
...
def test_unexpected_side_effect_fails_even_if_requested_change_succeeds():
    before, after = calendar_states()
